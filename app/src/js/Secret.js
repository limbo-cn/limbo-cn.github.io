...
export default class Secret {
    constructor() {
        ...
        this.secrets = [
            ...
            '明明不擅长算术,还要坚持做算术相关的工作,如果说这个项目是程序猿最后的倔强，那你的职业选择估计也是你最后的倔强了吧,不管是好是坏,努力过就好啦🍉',
            `我们已经相爱${this.getKnowTime()}天啦!💗`,
            this.getMarryTime() > 0 ? `还有${this.getMarryTime()}天,我们就要结婚啦!💗` : `我们已经结婚啦!要一直幸福下去,直到永远噢🌸`,
            '虽然我很怂,一直都怂,最大胆的一次,就是想让全世界都看到我对你的告白🎁',
            '你最喜欢的数字是369,发个动态都要等分针指向369才发,有的时候觉得很傻,有时候又觉得特别可爱🍄',
            '第一次去迪士尼的时候,你戴着仙女发箍,我们拍了很多很多照片,当时我的在想,如果这就是是现实中的城堡,那你就是我的公主👰',
        ]
        this.badMemory = [
            '还记得那次在停车场哭,以后不想再发生了😪',
            '去韩国的时候,明明说要带我去牛岛玩,结果还是在屡次不开心之后在我的带领下来到了牛岛🐂',
        ]
        this.blue = [
