<template>
  <div>
    ...
    <div id="letter" class="icon" @click.stop="empty">
      <span data-descr="每一颗心心里都藏着我对你的告白，不同的颜色象征着我们的爱情之路，时而甜蜜，时而心酸，虽然聚少离多，但我们最终还是坚持到了最后，汇聚成了这片海洋，探索这片海洋，发现更多秘密,找到只属于你的那颗红色小心心吧🎉">
        <svg class="icon" aria-hidden="true">
    ...
    <div id="info" class="icon" @click.stop="empty">
      <span data-descr="作者:dtl(limbo),这个项目是我自己一点点撸出来的,为了向张老板求婚可以说是很拼了,需要源码或者技术交流的同学可以加我微信firelimbo1992,电脑端比较好看>.<建议电脑登录,网速慢声音图片出不来可以多等等,不支持IE">
        <svg class="icon" aria-hidden="true">
